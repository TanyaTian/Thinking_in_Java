...
import static thinking_in_java.generics.watercolors.Watercolors.BRILLIANT_RED;
import static thinking_in_java.generics.watercolors.Watercolors.BURNT_UMBER;
import static thinking_in_java.generics.watercolors.Watercolors.CERULEAN_BLUE_HUE;
import static thinking_in_java.generics.watercolors.Watercolors.VIRIDIAN_HUE;
import static thinking_in_java.net.mindview.util.Print.print;
import static thinking_in_java.net.mindview.util.Sets.complement;
import static thinking_in_java.net.mindview.util.Sets.difference;
import static thinking_in_java.net.mindview.util.Sets.intersection;
import static thinking_in_java.net.mindview.util.Sets.union;
